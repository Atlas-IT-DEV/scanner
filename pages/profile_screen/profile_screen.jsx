...
const ProfileScreen = observer(() => {
  ...
  console.log(pageStore.username);
  const [name, setName] = useState(pageStore.username);
  const [phone, setPhone] = useState(pageStore.phoneNumber);
  ...
  const createUser = async () => {
    const values = {
      id: 0,
      first_name: pageStore.username.split(" ")[0],
      last_name: pageStore.username.split(" ")[1],
